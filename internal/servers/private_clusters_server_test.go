...
var _ = Describe("Private clusters server", func() {
	...
	Describe("Behaviour", func() {
		...
		It("Create object", func() {
			...
			Expect(private.GetOrderId()).To(Equal("my_order"))
		...
		It("List objects", func() {
			...
			for i := range size {
				...
				Expect(private[i].GetOrderId()).To(Equal(fmt.Sprintf("my_order_%d", i)))
		...
		It("Update object", func() {
			...
			Expect(err).ToNot(HaveOccurred())
			Expect(updateResponse.GetPrivate().GetOrderId()).To(Equal("your_order"))
			...
			Expect(err).ToNot(HaveOccurred())
			Expect(getResponse.GetPrivate().GetOrderId()).To(Equal("your_order"))
