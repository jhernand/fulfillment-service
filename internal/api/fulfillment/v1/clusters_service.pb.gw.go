...
var filter_Clusters_UpdateStatus_0 = &utilities.DoubleArray{Encoding: map[string]int{"status": 0, "id": 1}, Base: []int{1, 1, 2, 0, 0}, Check: []int{0, 1, 1, 2, 3}}

func request_Clusters_UpdateStatus_0(ctx context.Context, marshaler runtime.Marshaler, client ClustersClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq ClustersUpdateStatusRequest
		metadata runtime.ServerMetadata
		err      error
	)
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_Clusters_UpdateStatus_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func local_request_Clusters_UpdateStatus_0(ctx context.Context, marshaler runtime.Marshaler, server ClustersServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq ClustersUpdateStatusRequest
		metadata runtime.ServerMetadata
		err      error
...
func RegisterClustersHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ClustersServer) error {
	...
	mux.Handle(http.MethodPatch, pattern_Clusters_UpdateStatus_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/fulfillment.v1.Clusters/UpdateStatus", runtime.WithHTTPPathPattern("/api/fulfillment/v1/clusters/{id}/status"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Clusters_UpdateStatus_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_Clusters_UpdateStatus_0(annotatedContext, mux, outboundMarshaler, w, req, response_Clusters_UpdateStatus_0{resp.(*ClustersUpdateStatusResponse)}, mux.GetForwardResponseOptions()...)
	})
...
func RegisterClustersHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ClustersClient) error {
	...
	mux.Handle(http.MethodPatch, pattern_Clusters_UpdateStatus_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/fulfillment.v1.Clusters/UpdateStatus", runtime.WithHTTPPathPattern("/api/fulfillment/v1/clusters/{id}/status"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Clusters_UpdateStatus_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
type response_Clusters_UpdateStatus_0 struct {
	*ClustersUpdateStatusResponse
}

func (m response_Clusters_UpdateStatus_0) XXX_ResponseBody() interface{} {
	return m.Status
}
...
var (
	...
	pattern_Clusters_UpdateStatus_0         = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5}, []string{"api", "fulfillment", "v1", "clusters", "id", "status"}, ""))
)
...
var (
	...
	forward_Clusters_UpdateStatus_0         = runtime.ForwardResponseMessage
)
