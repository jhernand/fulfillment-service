...
// A compute instance template defines a type of compute instance that can be created by the user. Note that the user
// doesn't create these templates: the system provides a collection of them, and the user chooses one.
//
...
type ComputeInstanceTemplate struct {
	...
	xxx_hidden_Parent      *string                                        `protobuf:"bytes,6,opt,name=parent,proto3,oneof"`
...
func (x *ComputeInstanceTemplate) GetParent() string {
	if x != nil {
...
func (x *ComputeInstanceTemplate) SetParent(v string) {
...
func (x *ComputeInstanceTemplate) HasParent() bool {
	if x == nil {
		return false
	}
...
func (x *ComputeInstanceTemplate) ClearParent() {
...
func (x *ComputeInstanceTemplateParameterDefinition) GetSealed() bool {
	if x != nil {
...
func (x *ComputeInstanceTemplateParameterDefinition) SetSealed(v bool) {
...
type ComputeInstanceTemplateParameterDefinition_builder struct {
	...
	// by users when creating a compute instance. Child templates can seal parameters inherited from the parent. Once a
	// parameter is sealed it cannot be unsealed by further descendants.
	Sealed bool
}
...
var file_osac_public_v1_compute_instance_template_type_proto_rawDesc = string([]byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x9b, 0x02, 0x0a, 0x17, 0x43, 0x6f, 0x6d, 0x70, 0x75, 0x74, 0x65,
	...
	0x70, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x12, 0x1b, 0x0a, 0x06, 0x70, 0x61,
	0x72, 0x65, 0x6e, 0x74, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x06, 0x70, 0x61,
	0x72, 0x65, 0x6e, 0x74, 0x88, 0x01, 0x01, 0x42, 0x09, 0x0a, 0x07, 0x5f, 0x70, 0x61, 0x72, 0x65,
	0x6e, 0x74, 0x22, 0xf0, 0x01, 0x0a, 0x2a, 0x43, 0x6f, 0x6d, 0x70, 0x75, 0x74, 0x65, 0x49, 0x6e,
	...
	0x65, 0x61, 0x6c, 0x65, 0x64, 0x42, 0xe4, 0x01, 0x0a, 0x12, 0x63, 0x6f, 0x6d, 0x2e, 0x6f, 0x73,
...
func file_osac_public_v1_compute_instance_template_type_proto_init() {
	...
	file_osac_public_v1_compute_instance_template_type_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
