...
type ComputeInstanceTemplate struct {
	...
	xxx_hidden_AnsibleRole string                                         `protobuf:"bytes,6,opt,name=ansible_role,json=ansibleRole,proto3"`
...
func (x *ComputeInstanceTemplate) GetAnsibleRole() string {
	if x != nil {
...
func (x *ComputeInstanceTemplate) SetAnsibleRole(v string) {
...
type ComputeInstanceTemplate_builder struct {
	...
	// Name of the Ansible role that implements this template. When set, this value is passed to the hub compute
	// instance instead of the template identifier.
	AnsibleRole string
}
...
var file_osac_private_v1_compute_instance_template_type_proto_rawDesc = string([]byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x98, 0x02, 0x0a, 0x17, 0x43, 0x6f, 0x6d, 0x70,
	...
	0x21, 0x0a, 0x0c, 0x61, 0x6e, 0x73, 0x69, 0x62, 0x6c, 0x65, 0x5f, 0x72, 0x6f, 0x6c, 0x65, 0x18,
	0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x61, 0x6e, 0x73, 0x69, 0x62, 0x6c, 0x65, 0x52, 0x6f,
	0x6c, 0x65, 0x22, 0xd8, 0x01, 0x0a, 0x2a, 0x43, 0x6f, 0x6d, 0x70, 0x75, 0x74, 0x65, 0x49, 0x6e,
	...
	0x2e, 0x41, 0x6e, 0x79, 0x52, 0x07, 0x64, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x42, 0xeb, 0x01,
