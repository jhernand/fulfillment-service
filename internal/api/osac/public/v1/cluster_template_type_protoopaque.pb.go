...
//
// Templates support inheritance: a template can reference a parent template via the `parent` field. A child template
// inherits all parameter definitions from the parent and can override default values or seal parameters so that users
// cannot change them.
type ClusterTemplate struct {
	...
	xxx_hidden_Parent      *string                                `protobuf:"bytes,7,opt,name=parent,proto3,oneof"`
...
func (x *ClusterTemplate) GetParent() string {
	if x != nil {
...
func (x *ClusterTemplate) SetParent(v string) {
...
func (x *ClusterTemplate) HasParent() bool {
	if x == nil {
		return false
	}
...
func (x *ClusterTemplate) ClearParent() {
...
type ClusterTemplate_builder struct {
	...
	//
	// For child templates (those with a `parent`), this list contains only the parameters that the child wants to
	// override. Each entry must reference by `name` a parameter that exists in the parent. The child can set `sealed` to
	// `true` and provide a new `default` value. Fields like `type`, `title`, and `description` are inherited from the
	// parent.
	Parameters []*ClusterTemplateParameterDefinition
	// Initial node sets of the cluster.
	NodeSets map[string]*ClusterTemplateNodeSet
	// Identifier or name of the parent template. When set, this template inherits all parameter definitions from the
	// referenced parent, forming an inheritance chain. When empty, the template is a root template, typically backed by
	// an Ansible role.
	Parent *string
}
...
type ClusterTemplateParameterDefinition struct {
	...
	xxx_hidden_Sealed      bool                   `protobuf:"varint,7,opt,name=sealed,proto3"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
func (x *ClusterTemplateParameterDefinition) GetSealed() bool {
	if x != nil {
		return x.xxx_hidden_Sealed
	}
	return false
}
...
func (x *ClusterTemplateParameterDefinition) SetSealed(v bool) {
	x.xxx_hidden_Sealed = v
}
...
type ClusterTemplateParameterDefinition_builder struct {
	...
	Default *anypb.Any
	// Indicates if this parameter is sealed. A sealed parameter's value is locked to its `default` and cannot be changed
	// by users when creating a cluster. Child templates can seal parameters inherited from the parent. Once a parameter
	// is sealed it cannot be unsealed by further descendants.
	Sealed bool
}
...
var file_osac_public_v1_cluster_template_type_proto_rawDesc = string([]byte{
	...
	0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x22, 0x6f, 0x73, 0x61, 0x63, 0x2f, 0x70, 0x75,
	0x62, 0x6c, 0x69, 0x63, 0x2f, 0x76, 0x31, 0x2f, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61,
	0x5f, 0x74, 0x79, 0x70, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xbc, 0x03, 0x0a, 0x0f,
	...
	0x73, 0x12, 0x4a, 0x0a, 0x09, 0x6e, 0x6f, 0x64, 0x65, 0x5f, 0x73, 0x65, 0x74, 0x73, 0x18, 0x06,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x2d, 0x2e, 0x6f, 0x73, 0x61, 0x63, 0x2e, 0x70, 0x75, 0x62, 0x6c,
	0x69, 0x63, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x54, 0x65, 0x6d,
	0x70, 0x6c, 0x61, 0x74, 0x65, 0x2e, 0x4e, 0x6f, 0x64, 0x65, 0x53, 0x65, 0x74, 0x73, 0x45, 0x6e,
	0x74, 0x72, 0x79, 0x52, 0x08, 0x6e, 0x6f, 0x64, 0x65, 0x53, 0x65, 0x74, 0x73, 0x12, 0x1b, 0x0a,
	0x06, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52,
	0x06, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x88, 0x01, 0x01, 0x1a, 0x63, 0x0a, 0x0d, 0x4e, 0x6f,
	...
	0x75, 0x73, 0x74, 0x65, 0x72, 0x54, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x4e, 0x6f, 0x64,
	0x65, 0x53, 0x65, 0x74, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x42,
	0x09, 0x0a, 0x07, 0x5f, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x22, 0xe8, 0x01, 0x0a, 0x22, 0x43,
	...
	0x2e, 0x41, 0x6e, 0x79, 0x52, 0x07, 0x64, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x12, 0x16, 0x0a,
	0x06, 0x73, 0x65, 0x61, 0x6c, 0x65, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x73,
	0x65, 0x61, 0x6c, 0x65, 0x64, 0x22, 0x4b, 0x0a, 0x16, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72,
	0x54, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x4e, 0x6f, 0x64, 0x65, 0x53, 0x65, 0x74, 0x12,
	...
	0x7a, 0x65, 0x42, 0xdc, 0x01, 0x0a, 0x12, 0x63, 0x6f, 0x6d, 0x2e, 0x6f, 0x73, 0x61, 0x63, 0x2e,
...
var file_osac_public_v1_cluster_template_type_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_osac_public_v1_cluster_template_type_proto_goTypes = []any{
	...
	nil,                                        // 3: osac.public.v1.ClusterTemplate.NodeSetsEntry
	(*Metadata)(nil),                           // 4: osac.public.v1.Metadata
	(*anypb.Any)(nil),                          // 5: google.protobuf.Any
}
var file_osac_public_v1_cluster_template_type_proto_depIdxs = []int32{
	4, // 0: osac.public.v1.ClusterTemplate.metadata:type_name -> osac.public.v1.Metadata
	1, // 1: osac.public.v1.ClusterTemplate.parameters:type_name -> osac.public.v1.ClusterTemplateParameterDefinition
	3, // 2: osac.public.v1.ClusterTemplate.node_sets:type_name -> osac.public.v1.ClusterTemplate.NodeSetsEntry
	5, // 3: osac.public.v1.ClusterTemplateParameterDefinition.default:type_name -> google.protobuf.Any
	2, // 4: osac.public.v1.ClusterTemplate.NodeSetsEntry.value:type_name -> osac.public.v1.ClusterTemplateNodeSet
...
func file_osac_public_v1_cluster_template_type_proto_init() {
	...
	file_osac_public_v1_cluster_template_type_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
