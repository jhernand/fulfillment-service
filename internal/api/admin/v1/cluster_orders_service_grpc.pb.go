...
const (
	ClusterOrders_List_FullMethodName   = "/admin.v1.ClusterOrders/List"
	ClusterOrders_Get_FullMethodName    = "/admin.v1.ClusterOrders/Get"
	ClusterOrders_Create_FullMethodName = "/admin.v1.ClusterOrders/Create"
	ClusterOrders_Delete_FullMethodName = "/admin.v1.ClusterOrders/Delete"
	ClusterOrders_Update_FullMethodName = "/admin.v1.ClusterOrders/Update"
)
...
var ClusterOrders_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "admin.v1.ClusterOrders",
	...
	Metadata: "admin/v1/cluster_orders_service.proto",
}
