...
type ClusterOrdersListResponse struct {
	...
	xxx_hidden_Public      *[]*v1.ClusterOrder    `protobuf:"bytes,3,rep,name=public,proto3"`
	xxx_hidden_Private     *[]*ClusterOrder       `protobuf:"bytes,4,rep,name=private,proto3"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
...
type ClusterOrdersGetResponse struct {
	state              protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Public  *v1.ClusterOrder       `protobuf:"bytes,1,opt,name=public,proto3"`
	xxx_hidden_Private *ClusterOrder          `protobuf:"bytes,2,opt,name=private,proto3"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
