...
type ClustersListResponse struct {
	...
	Public        []*v1.Cluster          `protobuf:"bytes,3,rep,name=public,proto3" json:"public,omitempty"`
	Private       []*Cluster             `protobuf:"bytes,4,rep,name=private,proto3" json:"private,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ClustersGetResponse struct {
	state         protoimpl.MessageState `protogen:"hybrid.v1"`
	Public        *v1.Cluster            `protobuf:"bytes,1,opt,name=public,proto3" json:"public,omitempty"`
	Private       *Cluster               `protobuf:"bytes,2,opt,name=private,proto3" json:"private,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
