...
const (
	Metadata_Get_FullMethodName = "/metadata.v1.Metadata/Get"
)
...
func (UnimplementedMetadataServer) Get(context.Context, *MetadataGetRequest) (*MetadataGetResponse, error) {
...
var Metadata_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "metadata/v1/metadata_service.proto",
}
