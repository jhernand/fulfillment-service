...
type ClusterStatus struct {
	...
	xxx_hidden_Port       int32                      `protobuf:"varint,8,opt,name=port,proto3"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *ClusterStatus) GetPort() int32 {
	if x != nil {
...
func (x *ClusterStatus) SetPort(v int32) {
	x.xxx_hidden_Port = v
}
...
type ClusterStatus_builder struct {
	...
	Alias string
	// The node port number that is used by the API service.
	Port int32
}
...
var file_private_v1_cluster_type_proto_rawDesc = string([]byte{
	...
	0x3a, 0x02, 0x38, 0x01, 0x22, 0x92, 0x03, 0x0a, 0x0d, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72,
	...
	0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x61, 0x6c, 0x69, 0x61, 0x73, 0x12, 0x12, 0x0a, 0x04,
	...
	0x08, 0x5f, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x59, 0x0a, 0x0e, 0x43, 0x6c, 0x75,
	...
	0x6f, 0x73, 0x74, 0x73, 0x2a, 0x7f, 0x0a, 0x0c, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x53,
