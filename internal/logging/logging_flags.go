...
This is intended for situations where multiple processew are writing to the
...
_[BOOLEAN]_ - Enables or disables redactiong security sensitive data from the log.
`
