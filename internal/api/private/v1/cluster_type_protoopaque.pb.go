...
type ClusterStatus struct {
	...
	xxx_hidden_Alias      string                     `protobuf:"bytes,7,opt,name=alias,proto3"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *ClusterStatus) GetAlias() string {
	if x != nil {
...
func (x *ClusterStatus) SetAlias(v string) {
...
type ClusterStatus_builder struct {
	...
	Hub string
	// Alias used to refer to the cluster inside the hub. This is needed because the cluster may not have a name, or it
	// may already be in use by another cluster, in the same or another tenant. It may also be too long to use as the
	// name for Kubernetes objects. So the service will calculate a suitable alias.
	Alias string
}
...
type ClusterNodeSet struct {
	...
	xxx_hidden_Hosts     []string               `protobuf:"bytes,3,rep,name=hosts,proto3"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *ClusterNodeSet) GetHosts() []string {
	if x != nil {
...
func (x *ClusterNodeSet) SetHosts(v []string) {
...
type ClusterNodeSet_builder struct {
	...
	HostClass string
	Size      int32
	// List of identifiers of the hosts that have been assigned to this cluster.
	Hosts []string
}
...
var file_private_v1_cluster_type_proto_rawDesc = string([]byte{
	...
	0x3a, 0x02, 0x38, 0x01, 0x22, 0xfe, 0x02, 0x0a, 0x0d, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72,
	...
	0x09, 0x52, 0x03, 0x68, 0x75, 0x62, 0x12, 0x14, 0x0a, 0x05, 0x61, 0x6c, 0x69, 0x61, 0x73, 0x18,
	0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x61, 0x6c, 0x69, 0x61, 0x73, 0x1a, 0x57, 0x0a, 0x0d,
	...
	0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x9d, 0x02, 0x0a, 0x10, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65,
	0x72, 0x43, 0x6f, 0x6e, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x34, 0x0a, 0x04, 0x74, 0x79,
	0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x20, 0x2e, 0x70, 0x72, 0x69, 0x76, 0x61,
	...
	0x32, 0x1a, 0x2e, 0x73, 0x68, 0x61, 0x72, 0x65, 0x64, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x6f, 0x6e,
	...
	0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x59, 0x0a, 0x0e, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72,
	0x4e, 0x6f, 0x64, 0x65, 0x53, 0x65, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x68, 0x6f, 0x73, 0x74, 0x5f,
	...
	0x20, 0x01, 0x28, 0x05, 0x52, 0x04, 0x73, 0x69, 0x7a, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x68, 0x6f,
	0x73, 0x74, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x09, 0x52, 0x05, 0x68, 0x6f, 0x73, 0x74, 0x73,
	...
	0x45, 0x44, 0x10, 0x04, 0x42, 0xb7, 0x01, 0x0a, 0x0e, 0x63, 0x6f, 0x6d, 0x2e, 0x70, 0x72, 0x69,
	0x76, 0x61, 0x74, 0x65, 0x2e, 0x76, 0x31, 0x42, 0x10, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72,
