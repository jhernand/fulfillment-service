...
type HostSpec struct {
	...
	Bmc *BMC `protobuf:"bytes,2,opt,name=bmc,proto3" json:"bmc,omitempty"`
	...
	BootMac string `protobuf:"bytes,5,opt,name=boot_mac,json=bootMac,proto3" json:"boot_mac,omitempty"`
	// IP address of the network interface used for initial network boot.
	BootIp        string `protobuf:"bytes,6,opt,name=boot_ip,json=bootIp,proto3" json:"boot_ip,omitempty"`
	Title         string `protobuf:"bytes,7,opt,name=title,proto3" json:"title,omitempty"`
	Description   string `protobuf:"bytes,8,opt,name=description,proto3" json:"description,omitempty"`
	BcmLink       string `protobuf:"bytes,9,opt,name=bcm_link,json=bcmLink,proto3" json:"bcm_link,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
